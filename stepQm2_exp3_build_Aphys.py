...
BASE_FIX = "3nl-fix17.37_exp1"
SESSION_TAG = "exp1_3nl_fix17.37"
SESSION_ROOT = os.path.join(ROOT, "ML", "GRU_2", "processed_Qm_sessions", SESSION_TAG)

CLEAN_FIX_PATH = os.path.join(
    SESSION_ROOT, "stepQm0_clean", f"{BASE_FIX}_clean.csv"
)

SWEEP_PARAM_PATH = os.path.join(
    SESSION_ROOT, "stepQm1p_params_sweep", "params_1.5-swp30s.json"
)

OUT_DIR  = os.path.join(SESSION_ROOT, "stepQm2_phys")
