# ============================================================
# stepQm4c_qm_required_boundcheck.py
...
MEAS_CSV = os.path.join(ROOT, "processed_Qm", "stepQm1_meas", "data", "A_meas_1k.csv")
PHYS_CSV = os.path.join(ROOT, "processed_Qm", "stepQm2_phys", "data", "A_phys_1k.csv")

# Qm_ref from sweep
Qm_ref = 37.731707

OUT_DIR = os.path.join(ROOT, "processed_Qm", "stepQm4c_boundcheck")
